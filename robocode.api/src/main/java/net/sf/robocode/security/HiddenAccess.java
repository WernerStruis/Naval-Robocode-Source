...
public class HiddenAccess {
	...
	public static BattleRules createRules(int battlefieldWidth, int battlefieldHeight, int numRounds, double gunCoolingRate, long inactivityTime, boolean hideEnemyNames, int sentryBorderSize, String radarConfig, String cannonConfig, String shipConfig, double singleBarrelRange, double doubleBarrelRange) {
