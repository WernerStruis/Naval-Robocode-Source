...
public class FileUtil {
	 ...
	 * @return a File that is the directory containing the robots
	 */
	public static File getCompetitionDir() {
//		String robotPath = System.getProperty("ROBOTPATH");
		File file;
...
//		}
	 ...
	 * @return a File that is the directory containing the robot cache.
	 */
	public static File getCompetitionDatabaseFile() {
		return new File(getCompetitionDir(), "/robot.database");
	}
	 ...
	 * @return a File that is the directory containing configuration files
	 */
	public static File getExludedBotsDir() {
		return createDir(new File(cwd, "/excluded"));
	}
...
//	/**E
//	 * Returns the Default Robocode configuration file. This file is not supposed to change
//	 *
//	 * @return a File that is the Robocode configuration file.
//	 */
//	public static File getRobocodeDefaulltConfigFile() {
//		return new File(getConfigDir(), "robocode-default.properties");
//	}
