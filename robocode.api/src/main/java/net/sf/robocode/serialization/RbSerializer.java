...
public final class RbSerializer {
	...
	public final static byte GunType_TYPE = 75;
		
	//       Custom once go down from 127(7F) (Java uses SBYTE!)
	public final static byte ShortRangeRadar_TYPE = 0x7F;
	public final static byte LongRangeRadar_TYPE = 0x7D;

	public final static byte SingleBarrelCannon_TYPE = 0x7E;
	public final static byte DoubleBarrelCannon_TYPE = 0x7A;
