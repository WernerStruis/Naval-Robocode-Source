...
public class Coordinates {
	...
	public static final AffineTransform getAffineTransformShip(ITransformablePeer peer) {
		AffineTransform at = new AffineTransform();
		ShipType type = ShipType.getTypeByID(((ITransformable) peer).getShipFlag());

//		System.out.println(peer.getX() + "," + peer.getY() + "   - " + type);

			at.translate(peer.getX() - type.getHalfWidth(), peer.getY() - type.getProwOffset());
			at.rotate(peer.getBodyHeading(), type.getHalfWidth(), type.getProwOffset());
