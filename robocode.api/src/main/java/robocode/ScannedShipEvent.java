...
public class ScannedShipEvent extends Event {
	 ...
	 */
	public ScannedShipEvent(String name, double energy, double[] slotBearings, double bearingRadar, double distance, double heading, double velocity) {
		this.name = name;
		this.energy = energy;
...
//	}
	...
	public double getBearingRadians(){
		return Math.toRadians(bearingRadar);
	}
	...
	public final int compareTo(Event event) {
		...
		if (event instanceof ScannedShipEvent) {
			...
			return (this.name == obj.name &&
					...
					this.slotBearings == obj.slotBearings &&
	...
	private static class SerializableHelper implements ISerializableHelper {
		public int sizeOf(RbSerializer serializer, Object object) {
			...
			return RbSerializer.SIZEOF_TYPEINFO + serializer.sizeOf(obj.name) + 3 * RbSerializer.SIZEOF_DOUBLE + obj.slotBearings.length * RbSerializer.SIZEOF_DOUBLE;
		}
		...
		public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
			...
			return new ScannedShipEvent(name, energy, slotBearings, bearingRadar, distance, heading, velocity);
		}
	}
}
