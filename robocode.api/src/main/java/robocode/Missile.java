...
public class Missile extends Projectile {
     ...
     */
    public Missile(double heading, double x, double y, double power, double velocity, String ownerName, String victimName, boolean isActive, int missileId) {
    ...
    private static class HiddenMissileHelper implements IHiddenMissileHelper, ISerializableHelper {
        ...
        public int sizeOf(RbSerializer serializer, Object object) {
            ...
            return RbSerializer.SIZEOF_TYPEINFO + 5 * RbSerializer.SIZEOF_DOUBLE + serializer.sizeOf(obj.ownerName)
        ...
        public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
            ...
            return new Missile(headingRadians, x, y, power, velocity, ownerName, victimName, isActive, missileId);
        }
    }
}
