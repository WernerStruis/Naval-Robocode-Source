...
public interface IRenderImages {
	...
	IPaint getColoredGunRenderNavalImage(Integer color, CannonType type);
	...
	IPaint getColoredRadarRenderNavalImage(Integer color, RadarType type);
	...
	IPaint getColoredMissileComponentRenderNavalImage(Integer color);
