 ...
 */
public class DoubleBarrelCannon extends CannonComponent {

    private final int POWER = 2;

    /** Preserved for use during the serialization! **/
    public DoubleBarrelCannon(double startingAngle) {
    ...
    private DoubleBarrelCannon(double x, double y, double start, double extent, double startingAngle) {
        super(new Point2D.Double(x, y), CannonType.DOUBLE_BARREL, start, extent, startingAngle);
    }
    ...
    public byte getSerializeType(){
        return RbSerializer.DoubleBarrelCannon_TYPE;
