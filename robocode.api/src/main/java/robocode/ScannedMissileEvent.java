...
public class ScannedMissileEvent extends Event {
    ...
    private final double[] slotBearings;
     ...
     * @param slotBearings array of the bearings for all slots
     ...
     */
    public ScannedMissileEvent(String name, double power, double bearingRadar, double distance, double heading, double velocity, double x, double y, String owner, double[] slotBearings) {
        this.name = name;
        this.power = power;
        ...
        this.slotBearings = slotBearings;
...
//    }
    ...
    public final int compareTo(Event event) {
        ...
        if (event instanceof ScannedMissileEvent) {
            ...
            return (this.name == obj.name &&
                    ...
                    this.bearingRadar == obj.bearingRadar) ? 1 : 0;
        }
        // No difference found
        return 0;
    }
    ...
    private static class SerializableHelper implements ISerializableHelper {
        public int sizeOf(RbSerializer serializer, Object object) {
            ...
            return RbSerializer.SIZEOF_TYPEINFO + serializer.sizeOf(obj.name) + 6 * RbSerializer.SIZEOF_DOUBLE +  obj.slotBearings.length * RbSerializer.SIZEOF_DOUBLE;
        }
        ...
        public void serialize(RbSerializer serializer, ByteBuffer buffer, Object object) {
            ...
            serializer.serialize(buffer, obj.slotBearings);
        }
        ...
        public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
            ...
            double[] slotBearings = serializer.deserializeDoubles(buffer);


            return new ScannedMissileEvent(name, power, bearingRadar, distance, heading, velocity,x ,y, owner, slotBearings);
        }
    }
}
