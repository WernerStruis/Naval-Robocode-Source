...
public class Bullet extends Projectile {
	 ...
	 */
	public Bullet(double heading, double x, double y, double power, double velocity, String ownerName, String victimName, boolean isActive, int bulletId) {
	...
	private static class HiddenBulletHelper implements IHiddenBulletHelper, ISerializableHelper {
		...
		public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
			...
			return new Bullet(headingRadians, x, y, power, velocity, ownerName, victimName, isActive, bulletId);
		}
	}
}
