...
public abstract class _RobotBase implements IBasicRobot, Runnable {
	...
	static void uninitializedException() {
		...
		throw new RobotException(
				...
				+ "() method before your run() method is called, or you are using a Robot object that the game doesn't know about. Also make sure that your robot's  run method calls its super method.\n" + ttr);
	}
}
