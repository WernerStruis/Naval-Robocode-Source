...
public class MenuBar extends JMenuBar {
    ...
    private JMenuItem hostBattleNewMenuItem;
    ...
    private JMenuItem robotTransferMenuItem;
    ...
    private class EventHandler implements ActionListener, MenuListener {
        public void actionPerformed(ActionEvent e) {
            ...
            } else if (source == mb.getHostBattleNewMenuItem()) {
                hostBattleNewActionPerformed();
            ...
            } else if (source == mb.getRobotTransferMenuItem()) {
                transferRobotActionPerformed();
    ...
    /**
     * Handle hostBattleNew menu item action
     */
    private void hostBattleNewActionPerformed() {
        windowManager.showNewCompetitionDialog(battleManager.getBattleProperties());
    }

    /**
     * Handle hostBattleNew menu item action
     */
    private void transferRobotActionPerformed() {
        windowManager.showRobotTransfer();
    }
    ...
    public JMenu getBattleMenu() {
        if (battleMenu == null) {
            ...
            battleMenu.add(getHostBattleNewMenuItem());
    ...
    private JMenuItem getHostBattleNewMenuItem() {
        if (hostBattleNewMenuItem == null) {
            hostBattleNewMenuItem = new JMenuItem();
            hostBattleNewMenuItem.setText("Host Game");
            hostBattleNewMenuItem.setMnemonic('H');
            hostBattleNewMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_H, MENU_SHORTCUT_KEY_MASK, false));
            hostBattleNewMenuItem.addActionListener(eventHandler);
        }
        return hostBattleNewMenuItem;
    }
    ...
    public JMenu getRobotMenu() {
        if (robotMenu == null) {
            ...
            robotMenu.add(new JSeparator());
            robotMenu.add(getRobotTransferMenuItem());
    ...
    private JMenuItem getRobotTransferMenuItem() {
        if (robotTransferMenuItem == null) {
            robotTransferMenuItem = new JMenuItem();
            robotTransferMenuItem.setText("Export robot");
            robotTransferMenuItem.setMnemonic('T');
            robotTransferMenuItem.addActionListener(eventHandler);
        }
        return robotTransferMenuItem;
    }
