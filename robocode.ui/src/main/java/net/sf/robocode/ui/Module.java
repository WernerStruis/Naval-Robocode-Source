...
public class Module extends BaseModule {
	static {
		...
		Container.factory.addComponent(HostedContestantsPanel.class);
		...
		Container.factory.addComponent(NewCompetitionDialog.class);
		Container.factory.addComponent(BattleFieldSizeDialog.class);
		Container.factory.addComponent(TransferRobotDialog.class);
