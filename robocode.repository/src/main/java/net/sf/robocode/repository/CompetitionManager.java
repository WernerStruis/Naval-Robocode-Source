 ...
 */
public class CompetitionManager implements ICompetitionManager { // NO_UCD (use default)
    ...
    public CompetitionManager(ISettingsManager properties) { // NO_UCD (unused code)
    ...
    public File getRobotsDirectory() {
        return FileUtil.getCompetitionDir();
    }
    ...
    public RobotSpecification[] getContestantSpecifications() {
        checkDbExists();
    ...
    @Override
    public void removeContestants(List<String> toRemove) {
        for(String s : toRemove){
            if (repository.removeRobot(s)) {
                System.out.println(s + " Removed succesfully!");
            } else {
                System.out.println(s + " Remove failed.");
            }
        }
    }

//    @Override
//    public List<IRobotSpecItem> getContestantItems(boolean onlyWithSource, boolean onlyWithPackage, boolean onlyRobots, boolean onlyDevelopment, boolean onlyNotDevelopment, boolean ignoreTeamRobots, boolean onlyInJar, boolean onlyShips) {
////        checkDbExists();
////
////
////        final List<IRobotSpecItem> res = new ArrayList<IRobotSpecItem>();
////
////        for (IRepositoryItem repositoryItem : repository.getContestants().values()) {
////            final IRobotSpecItem spec = (IRobotSpecItem) repositoryItem;
////
////            if (!repositoryItem.isValid()) {
////                continue;
...
////                continue;
////            }
////            if(repository.getRemovedItems().values().contains(repositoryItem)){
////                continue;
////            }
////            res.add(spec);
////        }
