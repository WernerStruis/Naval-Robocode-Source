...
public class Module extends BaseModule {
	static {
		...
		Container.cache.addComponent(ICompetitionManager.class, CompetitionManager.class);
		Container.cache.addComponent(IRepositoryManagerBase.class, RepositoryManager.class);
