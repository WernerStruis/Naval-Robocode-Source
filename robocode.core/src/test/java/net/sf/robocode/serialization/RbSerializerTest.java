...
public class RbSerializerTest {
	...
	public void empty() throws IOException {
		HiddenAccess.initContainer();
		ExecCommands ec = new ExecCommands(15.4, 1, ShipType.CORVETTE.getMaxSlots());
	...
	public void withBullets() throws IOException {
		...
		ec.setBodyTurnRemaining(150.123);
		ec.getBullets().add(new BulletCommand(1.0, CannonType.SINGLE_BARREL, true, 0.9354, 11));
		ec.getBullets().add(new BulletCommand(1.0, CannonType.SINGLE_BARREL, false, 0.9454, 12));
		ec.getBullets().add(new BulletCommand(1.0, CannonType.SINGLE_BARREL, true, 0.9554, -128));
