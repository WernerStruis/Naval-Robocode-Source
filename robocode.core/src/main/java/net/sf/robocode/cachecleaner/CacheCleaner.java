...
public final class CacheCleaner {
	...
	public static void clean() {
		...
		deleteFile(FileUtil.getCompetitionDatabaseFile().getPath());
		...
		final ICompetitionManager competitionManager = Container.getComponent(ICompetitionManager.class);

		repositoryManager.reload(true);
		competitionManager.reload(true);
