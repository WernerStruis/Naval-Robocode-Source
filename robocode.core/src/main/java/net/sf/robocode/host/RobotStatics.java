...
public final class RobotStatics implements IRobotStatics, Serializable {
	...
	public RobotStatics(RobotSpecification robotSpecification, int duplicate, boolean isLeader, BattleRules rules, String teamName, List<String> teamMembers, int robotIndex, int teamIndex) {
		...
		this.shipFlag = robotItem.getShipFlag();
	...
	private RobotStatics(String robocodeVersion, boolean isJuniorRobot, boolean isInteractiveRobot, boolean isPaintRobot, boolean isAdvancedRobot,
			boolean isTeamRobot, boolean isTeamLeader, boolean isDroid, boolean isShip, int shipFlag, boolean isSentryRobot, String name, String shortName,
	...
	private static class SerializableHelper implements ISerializableHelper {
		public int sizeOf(RbSerializer serializer, Object object) {
			...
			int size = RbSerializer.SIZEOF_TYPEINFO +serializer.sizeOf(obj.robocodeVersion) + RbSerializer.SIZEOF_BOOL * 9 + serializer.sizeOf(obj.name)
					...
					+ RbSerializer.SIZEOF_INT * 7 + RbSerializer.SIZEOF_DOUBLE + RbSerializer.SIZEOF_LONG;
		...
		public void serialize(RbSerializer serializer, ByteBuffer buffer, Object object) {
			...
			serializer.serialize(buffer, obj.shipFlag);
			...
			//TODO maybe serialize config strings too?
			if (obj.teammates != null) {
				for (String mate : obj.teammates) {
		...
		public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
			...
			int shipFlag = serializer.deserializeInt(buffer);
			...
			return new RobotStatics( robocodeVersion,isJuniorRobot, isInteractiveRobot, isPaintRobot, isAdvancedRobot, isTeamRobot,
					isTeamLeader, isDroid, isShip, shipFlag, isSentryRobot, name, shortName, veryShortName, fullClassName, shortClassName,
