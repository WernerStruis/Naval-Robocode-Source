...
//	List<IRobotSpecItem> getContestantItems(boolean onlyWithSource, boolean onlyWithPackage, boolean onlyRobots, boolean onlyDevelopment, boolean onlyNotDevelopment, boolean ignoreTeamRobots, boolean onlyInJar, boolean onlyShips);
	void removeContestants(List<String> toRemove);
