...
public class BulletCommand implements Serializable {
	...
	public BulletCommand(double power, CannonType cannonType, boolean fireAssistValid, double fireAssistAngle, int bulletId) {
	...
	public BulletCommand(double power, boolean fireAssistValid, double fireAssistAngle, int bulletId) {
		...
		this.bulletId = bulletId;
		this.power = power;
		this.cannonType = CannonType.ORIGINAL;
	}
	...
	private static class SerializableHelper implements ISerializableHelper {
		public int sizeOf(RbSerializer serializer, Object object) {
			...
			return RbSerializer.SIZEOF_TYPEINFO + RbSerializer.SIZEOF_DOUBLE +
					serializer.sizeOf(RbSerializer.GunType_TYPE, null) + 1 + RbSerializer.SIZEOF_BOOL + RbSerializer.SIZEOF_DOUBLE + RbSerializer.SIZEOF_INT;
		...
		public void serialize(RbSerializer serializer, ByteBuffer buffer, Object object) {
			...
			serializer.serialize(buffer, RbSerializer.GunType_TYPE, obj.cannonType);
		...
		public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
			...
			Object o = serializer.deserializeAny(buffer);
			CannonType cannonType = (CannonType) (o instanceof CannonType ? o : null);
			...
			return new BulletCommand(power, cannonType, fireAssistValid, fireAssistAngle, bulletId);
		}
	}
}
