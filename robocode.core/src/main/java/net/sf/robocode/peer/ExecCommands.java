...
public final class ExecCommands implements Serializable{
	...
	private final double maxTurnRateConfig;
	private final double maxVelocityConfig;
	...
	public ExecCommands(double maxVelocity, double maxTurnRate, int maxComponents) {
		maxVelocityConfig = maxVelocity;
		maxTurnRateConfig = maxTurnRate;
	...
	public ExecCommands(ExecCommands origin, boolean fromRobot) {
		...
		maxTurnRateConfig = origin.maxTurnRateConfig;
		maxVelocityConfig = origin.maxVelocityConfig;
		maxTurnRate = origin.maxTurnRate;
		maxVelocity = origin.maxVelocity;
		radarType = origin.radarType;
		copyColors(origin);
...
//		boundingBox = origin.boundingBox;
	...
	public void setMaxTurnRate(double maxTurnRate) {
		this.maxTurnRate = Math.min(abs(maxTurnRate), Math.toRadians(this.maxTurnRateConfig));
	}
	...
	public void setMaxVelocity(double maxVelocity) {
		this.maxVelocity = Math.min(abs(maxVelocity), this.maxVelocityConfig);
	}
...
//			size += obj.getMaxComponents() * RbSerializer.SIZEOF_BOOL;
		...
		public Object deserialize(RbSerializer serializer, ByteBuffer buffer) {
			ExecCommands res = new ExecCommands(buffer.getDouble(), buffer.getDouble(), 0);
