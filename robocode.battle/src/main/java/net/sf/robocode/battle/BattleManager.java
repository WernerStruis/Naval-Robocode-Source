...
public class BattleManager implements IBattleManager {
	...
	public void startNewBattle(BattleProperties battleProperties, boolean waitTillOver, boolean enableCLIRecording) {
		...
		System.out.printf("BattleManager found the folowing configuration properties: \n"+
				"Ship Properties: %s \n" +
				"Radar Properties: %s \n" +
				"Cannon properties: %s \n",
				battleProperties.getShipConfiguration(),
				battleProperties.getRadarConfiguration(),
				battleProperties.getCannonConfiguration());
