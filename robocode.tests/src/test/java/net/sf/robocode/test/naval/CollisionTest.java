...
public class CollisionTest extends Collision {
	...
	public void testMissileCollisionWithShipTrue(){
		JMockShipPeer ship = new JMockShipPeer(300, 300, Math.toRadians(90));
		BoundingRectangle shipBox = new BoundingRectangle(ship.getX()- ShipType.CORVETTE.getHalfWidth(), ship.getY()-ShipType.CORVETTE.getHalfHeight(), ShipType.CORVETTE.getWidth(), ShipType.CORVETTE.getHeight());
	...
	public void testMissileCollisionWithMissileTrue(){
		...
		BoundingRectangle missile1Box = new BoundingRectangle(
				missile1.getX()-NavalRules.HALF_MISSILE_WIDTH_OFFSET, missile1.getY()-ShipType.CORVETTE.getHalfHeight(), NavalRules.MISSILE_WIDTH, NavalRules.MISSILE_HEIGHT );

		BoundingRectangle missile2Box = new BoundingRectangle(
				missile2.getX()-NavalRules.HALF_MISSILE_WIDTH_OFFSET, missile2.getY()-ShipType.CORVETTE.getHalfHeight(), NavalRules.MISSILE_WIDTH, NavalRules.MISSILE_HEIGHT );
	...
	public void testMissileCollisionWithMissileFalse(){
		...
		BoundingRectangle missile1Box = new BoundingRectangle(
				missile1.getX()-NavalRules.HALF_MISSILE_WIDTH_OFFSET, missile1.getY()-ShipType.CORVETTE.getHeight(), NavalRules.MISSILE_WIDTH, NavalRules.MISSILE_HEIGHT );

		BoundingRectangle missile2Box = new BoundingRectangle(
				missile2.getX()-NavalRules.HALF_MISSILE_WIDTH_OFFSET, missile2.getY()-ShipType.CORVETTE.getHeight(), NavalRules.MISSILE_WIDTH, NavalRules.MISSILE_HEIGHT );
	...
	public void testMissileCollisionWithBulletTrue(){
		...
		Bullet bullet = new Bullet(Math.toRadians(90), 300, 300, 3, CannonType.ORIGINAL.getMaxBulletPower(), "secondship", null, true, 0);
	...
	public void testMissileCollisionWithBulletFalse(){
		Missile missile = new Missile(Math.toRadians(90), 300, 300, 30, "firstship", null, true, 0);
		Bullet bullet = new Bullet(Math.toRadians(90)+Math.PI, 100, 100, 3, CannonType.ORIGINAL.getMaxBulletPower(),"secondship", null, true, 0);
		BoundingRectangle missileBox = new BoundingRectangle(
				missile.getX()-NavalRules.HALF_MISSILE_WIDTH_OFFSET, missile.getY()-ShipType.CORVETTE.getHeight(), NavalRules.MISSILE_WIDTH, NavalRules.MISSILE_HEIGHT );
	...
	public void testBulletCollisionWithBulletTrue(){
		Bullet bullet = new Bullet(Math.toRadians(90), 300, 300, 3, CannonType.ORIGINAL.getMaxBulletPower(), "firstship", null, true, 0);
		BoundingRectangle bulletBox = new BoundingRectangle(
				bullet.getX()-10.5, bullet.getY()-10.5, 21, 21);
		Bullet bullet2 = new Bullet(Math.toRadians(90)+Math.PI, 300, 300, 3, CannonType.ORIGINAL.getMaxBulletPower(), "secondship", null, true, 1);
	...
	public void testBulletCollisionWithBulletFalse(){
		...
		BoundingRectangle bulletBox = new BoundingRectangle(
				bullet.getX()-10.5, bullet.getY()-10.5, 21, 21);
		Bullet bullet2 = new Bullet(Math.toRadians(90)+Math.PI, 100, 100, 3, CannonType.ORIGINAL.getMaxBulletPower(), "secondship", null, true, 1);
		BoundingRectangle bulletBox2 = new BoundingRectangle(
				bullet2.getX()-10.5, bullet2.getY()-10.5, 21, 21);
